    ...
    <Box>
      ...
      <Box>
        ...
        >
          ...
          <Box>© 2023 QuickCart | All rights reserved</Box>
        </Flex>
      </Box>
      ...
      <Box textAlign={"left"} margin={"auto 30px"}>
        <Box margin={"20px auto"}>
          <Text as="b">
            Quick Cart: Shop Online with India's most trusted destination
          </Text>
          <Text>
        ...
        <Box margin={"20px auto"}>
          <Text as="b">
            Quick Cart Shopping App: just a few clicks on Android & iOS
          </Text>
          <Text>
        ...
        <Box margin={"20px auto"}>
          <Text as="b">
            Quick Cart: The most genuine place for Fashion and Lifestyle
          </Text>
          <Text>
            With an exclusive Brand Store for Westside Online we have most of
            your trendy shopping needs taken care of. Make Quick Cart your online
            ...
            can count on Quick Cart for receiving only the most authentic
            products.
          </Text>
        </Box>
      </Box>
